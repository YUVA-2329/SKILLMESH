...
export const INITIAL_USER: UserProfile = {
  ...
  email: 'alex@skillmesh.network',
  targetRole: 'AI Engineer',
  skillFitScore: 62,
  verifiedArtifactsCount: 14,
  activeMissionsCount: 3,
  summary: 'Aspiring AI Engineer passionate about building neural applications, computer vision pipelines, and intelligent software.',
  githubConnected: true,
  githubUsername: 'alex-builds',
  resumeUploaded: true,
  privacy: {
...
export const INITIAL_SKILLS: SkillNode[] = [
  {
    ...
    name: 'Python',
    category: 'Languages',
    description: 'High-level programming language used for scripting, data science, machine learning models, and backend APIs.',
    ...
    leadsTo: ['FastAPI', 'Machine Learning', 'Computer Vision'],
    relatedSkills: ['SQL', 'FastAPI', 'Machine Learning'],
    connectedArtifacts: [
      { id: 'art-1', title: 'Data Pipeline Script', type: 'code', updatedAt: '2 days ago', url: 'https://github.com/alex-builds/python-data-pipeline' },
      { id: 'art-2', title: 'Text Classification Model', type: 'model', updatedAt: '1 week ago', url: 'https://github.com/alex-builds/nlp-classifier' },
  ...
  },
  {
    ...
    description: 'Relational queries, database indexing, joins, and data manipulation.',
    ...
    leadsTo: ['Vector Databases', 'Backend Optimization'],
    relatedSkills: ['Python', 'PostgreSQL', 'FastAPI'],
    connectedArtifacts: [
      { id: 'art-db-1', title: 'Analytics Schema & Queries', type: 'code', updatedAt: '3 days ago' }
    ],
    evidenceIds: ['ev-13']
  },
  {
    ...
    name: 'React',
    category: 'Frontend',
    description: 'Frontend component architecture, state management, and user interfaces.',
    ...
    leadsTo: ['Next.js', 'Full-Stack Apps'],
    relatedSkills: ['TypeScript', 'Tailwind CSS'],
    connectedArtifacts: [
      { id: 'art-fe-1', title: 'Portfolio & Dashboard App', type: 'deployment', updatedAt: 'Yesterday' }
    ],
    evidenceIds: ['ev-10']
  },
  {
    ...
    category: 'AI & ML',
    description: 'Training and evaluating classification and regression models using scikit-learn and neural networks.',
    ...
    leadsTo: ['Computer Vision', 'Deep Learning', 'RAG'],
    relatedSkills: ['Python', 'Computer Vision', 'PyTorch'],
    connectedArtifacts: [
      { id: 'art-ml-1', title: 'Customer Churn Predictor', type: 'model', updatedAt: '5 days ago' }
    ],
    evidenceIds: ['ev-4']
  },
  {
    ...
    category: 'AI & ML',
    description: 'Image processing, convolutional neural networks, OpenCV, and object detection.',
    ...
    status: 'gap',
    isCoreCompetency: true,
    position3D: [1.2, 1.4, 0.2],
    prerequisites: ['Machine Learning', 'Python'],
    leadsTo: ['Autonomous Vehicles', 'Robotics AI'],
    relatedSkills: ['Machine Learning', 'Python', 'PyTorch'],
    connectedArtifacts: [
      { id: 'art-cv-1', title: 'Basic OpenCV Edge Detector', type: 'code', updatedAt: '2 weeks ago' }
    ],
    evidenceIds: ['ev-cv-1']
  },
  {
    ...
    description: 'Containerizing apps, writing Dockerfiles, and putting models on the web.',
    ...
    leadsTo: ['Kubernetes', 'Cloud Hosting'],
    relatedSkills: ['FastAPI', 'Python'],
    connectedArtifacts: [
      { id: 'art-doc-1', title: 'Dockerized Flask API', type: 'deployment', updatedAt: '1 week ago' }
    ],
    evidenceIds: ['ev-8']
  },
  {
    ...
    name: 'FastAPI',
    category: 'Backend',
    description: 'High-speed Python web framework for building APIs that serve machine learning models.',
    ...
    leadsTo: ['Microservices'],
    relatedSkills: ['Python', 'Docker & Deployment'],
    connectedArtifacts: [
      { id: 'art-api-1', title: 'ML Inference Microservice', type: 'code', updatedAt: '3 days ago' }
    ],
    evidenceIds: ['ev-7']
  },
  {
